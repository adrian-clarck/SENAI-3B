...
CREATE TABLE
    IF NOT EXISTS cardapio_produto (
...
INSERT INTO
    produto (nome, descricao, preco, categoria, disponivel)
VALUES
    (
        'Espaguete à Bolonhesa',
        'Massa com molho de tomate e carne moída',
        35.50,
        'Massa',
        true
    ),
    (
        'Lasanha de Frango',
        'Lasanha com frango desfiado e queijo',
        42.00,
        'Massa',
        true
    ),
    (
        'Pizza Margherita',
        'Pizza de mussarela, tomate e manjericão',
        50.00,
        'Pizza',
        true
    ),
